...
function bbox(geojson) {
    ...
    meta$1.coordEach(geojson, function (coord) {
        if (result[0] > coord[0]) {
            result[0] = coord[0];
        }
        if (result[1] > coord[1]) {
...
var featureCollection$1 = helpers.featureCollection;
    ...
    flattenEach(splitter, function (point) {
        ...
        if (!results.length) {
            ...
            results.forEach(function (feature) {
                if (!feature.bbox) feature.bbox = square(bbox$1(feature));
            });
...
const sourcePointAndLineId = "points-and-lines";
...
const referencePointsCircleLayer = {
...
const referencePointsTextLayer = {
    id: pointTextLayerId,
    type: "symbol",
    source: sourcePointAndLineId,
...
class MapboxPathControl {
    ...
    createUI() {
        ...
        if (this.directionsThemes && this.directionsThemes.length > 0) {
            ...
            pathControlSelect.onchange = (event) => {
                var _a;
                this.selectedDirectionsTheme = (_a = this.directionsThemes) === null || _a === void 0 ? void 0 : _a.find((directionsTheme) => directionsTheme.id ===
    ...
    initializeSourceAndLayers() {
        ...
        this.map.addLayer(this.layersCustomisation &&
            ...
            ? Object.assign(Object.assign({}, referencePointsCircleLayer), this.layersCustomisation.pointCircleLayerCustomisation) : referencePointsCircleLayer);
        this.map.addLayer(this.layersCustomisation &&
            this.layersCustomisation.pointTextLayerCustomisation
            ? Object.assign(Object.assign({}, referencePointsTextLayer), this.layersCustomisation.pointTextLayerCustomisation) : referencePointsTextLayer);
        this.map.addLayer(this.layersCustomisation &&
    ...
    onClickMap(event) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!referencePointOrLineIsUnderMouse) {
                ...
                const previousReferencePoint = this.referencePoints.length > 0
    ...
    onContextMenuLine(event) {
        ...
        const createIntermediatePointOnLineButton = document.createElement("button");
        ...
        createIntermediatePointOnLineButton.onclick = () => this.createIntermediatePointOnLine(event);
        ...
        changePathModeOnButton.onclick = () => this.changeDirectionsModeOnLine(lineUnderMouse[0]);
        ...
        if (this.directionsThemes && this.directionsThemes.length > 0) {
            ...
            changePathModeOnLineButton.onclick = () => this.changeDirectionsModeOnLine(lineUnderMouse[0]);
    ...
    createNewPointAndLine(newPointCoordinates, directionsIsActive, previousLineCoordinates, nextLineCoordinates, currentLineIndex, waypoints) {
        ...
        if (previousLineCoordinates) {
            ...
            if (currentLineIndex !== undefined) {
                this.linesBetweenReferencePoints.splice(currentLineIndex, 1, previousLineBetweenReferencePoint);
            }
            else {
                this.linesBetweenReferencePoints.push(previousLineBetweenReferencePoint);
            }
        }
